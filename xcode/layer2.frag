...
void main(void) {
    ...
    vec4 color1 = HSLToRGB(transformHSL(RGBToHSL(blue1), fract(u_time / 17.0), 1.0, 0.8));
    vec4 color2 = HSLToRGB(transformHSL(RGBToHSL(blue2), fract(u_time / 22.0), 1.0, 0.8));
    vec4 color3 = HSLToRGB(transformHSL(RGBToHSL(blue1), fract(u_time / 12.0), 1.0, 0.8));
